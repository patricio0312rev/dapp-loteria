...
// Patricio     => 0xAb8483F64d9C6d1EcF9b849Ae677dD3315835cb2
// Marroquin    => 0x4B20993Bc481177ec7E8f571ceCaE8A9e22C02db
...
interface IERC20 {
    ...
    // Función única para la loteria
    function transferLoteria(address _emisor, address recipient, uint256 amount) external returns (bool);
...
contract ERC20Basic is IERC20 {
    ...
    // Función única para la loteria
    function transferLoteria(address _emisor, address recipient, uint256 numTokens) public override returns (bool) {
